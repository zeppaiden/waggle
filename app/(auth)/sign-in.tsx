  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.subtitle}>Your furry friends missed you!</Text>
      </View>
      ...
      <View style={styles.formContainer}>
        ...
        >
          {loading ? 'Fetching Treats...' : 'Sign In'}
        </Button>
      </View>
      
      <View style={styles.footer}>
        <Text style={styles.footerText}>Don't have an account? </Text>
        <Link href="/(auth)/sign-up" style={styles.footerLink}>Join the Pack!</Link>
      </View>
